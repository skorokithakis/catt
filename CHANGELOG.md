...
* Raise CastError instead of hanging forever when a device does not connect ([f9380bb](https://github.com/skorokithakis/catt/commit/f9380bbd546c5cfe9def1354d5ec8604b2a1ecec))
* Replace dead direct-link URL in tests with a stable Wikimedia one ([40a65ee](https://github.com/skorokithakis/catt/commit/40a65ee37cc536b81f962f135aaab2680324eab2))
* Time out instead of hanging forever while waiting on a device ([3d5c4cc](https://github.com/skorokithakis/catt/commit/3d5c4cc21b31ad858589b9275816d074bf85fcfe))
...
## [0.13.1](https://github.com/skorokithakis/catt/compare/v0.13.0...v0.13.1) (2025-08-19)
